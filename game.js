...
export default class GameScene extends Phaser.Scene {
    ...
    createUI() {
        ...
        this.add.text(window.innerWidth - 220, 20, 'Leaderboard', { fontSize: '18px', fill: '#ffd700', fontStyle: 'bold' }).setScrollFactor(0).setDepth(200);
        for (let i = 0; i < 5; i++) {
            this.leaderboardEntries.push(this.add.text(window.innerWidth - 220, 50 + (i * 25), '', { fontSize: '14px', fill: '#fff' }).setScrollFactor(0).setDepth(200));
        }
    }
